      ...
      <table class="table table-striped table-bordered table-hover table-reponsive bang">
        ...
        foreach ($danhsachdanhmuc as $danhmuc) {
          ...
          echo '<tr>
             ...
             <td>' . $NAME . '</td>
             <td>
             <a href="' . $suadm . '"class="btn btn-danger"><i class="fa fa-pencil " aria-hidden="true">Sửa</i></a> |   <a href="' . $xoadm . '" class="btn btn-warning"><i class="fa fa-trash-o " aria-hidden="true">Xóa</i></a>
             </td>
           </tr>';
        }
        ?>
