          ...
          <ul class="navbar-nav float-end">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="dangxuat.php"><i class="fa fa-power-off me-1 ms-1"></i> Đăng xuất</a>
              </ul>
            </li>
            <!-- ============================================================== -->
            <!-- User profile and search -->
      ...
      <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
          <ul id="sidebarnav" class="pt-4">
            ...
            <li class="sidebar-item"> <a class="sidebar-link" href="index.php?act=danhmuc" aria-expanded="false"><span class="hide-menu">Danh mục</span></a>

            </li>

            <li class="sidebar-item"> <a class="sidebar-link" href="index.php?act=listsp" aria-expanded="false"><span class="hide-menu">Sản phẩm</span></a>

</li>


            <li class="sidebar-item"> <a class="sidebar-link" href="index.php?act=donhang" aria-expanded="false"><span class="hide-menu">Đơn hàng</span></a>

</li>
            <li class="sidebar-item"> <a class="sidebar-link" href="index.php?act=binhluan" aria-expanded="false"><span class="hide-menu">Bình luận</span></a>

            </li>
            <li class="sidebar-item"> <a class="sidebar-link" href="index.php?act=khachhang" aria-expanded="false"><span class="hide-menu">Khách hàng</span></a>

            </li>
            <li class="sidebar-item"> <a class="sidebar-link" href="index.php?act=thongke" aria-expanded="false"><span class="hide-menu">Thống kê</span></a>

</li>

            <li class="sidebar-item"> <a class="sidebar-link" href="../controller_user/index.php?act=taikhoan" aria-expanded="false"><span class="hide-menu">Quay lại</span></a>
